...
$(window).scroll(function(){
  ...
  if(top>10){
    $(".maintitle_top").css({"padding-right":top,"transform":"scale(1.3)","color":'#f7e8f2' })
    $(".maintitle_bottom").css({"padding-left":top,"transform":"scale(1.3)", "color":'#f7e8f2'})
  }else{
    $(".maintitle_top").css({"padding-right":top,"transform":"scale(1)", "color":'#D52A78' })
    $(".maintitle_bottom").css({"padding-left":top,"transform":"scale(1)", "color":'#D52A78'  })
  }
